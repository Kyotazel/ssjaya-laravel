        ...
        <div class="card-header d-flex align-items-center">
            <div class="card-title mb-0 flex-grow-1">
                <div class="btn btn-primary">
                    <h6 class="mb-0 text-light">Daftar Sales</h6>
                </div>
            </div>
                ...
                <form class="form_input">
                    ...
                    <div class="modal-body">
                        <div class="row text-dark">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="id_sales">Username</label>
                                    <input type="text" name="id_sales" class="form-control" id="id_sales"
    ...
    <script>
        ...
        $(document).on('click', '.btn_delete', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `{{ route('admin.sales.destroy', ':id') }}`.replace(':id', id),
                        type: "POST",
                        dataType: "JSON",
                        data: {
                            _token: `{{ csrf_token() }}`,
        ...
        $('.btn_save').click(function(e) {
            ...
            if (save_method == 'add') {
                ...
                url = `{{ route('admin.sales.update', ':id') }}`.replace(':id', id_use);
                status = "Diubah";
        ...
        $(document).on('click', '.btn_edit', function() {
            ...
            $.ajax({
                url: `{{ route('admin.sales.edit', ':id') }}`.replace(':id', id_use),
                type: 'GET',
                dataType: 'JSON',
                success: function(data) {
