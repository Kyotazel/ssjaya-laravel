        ...
        <div class="card-header d-flex align-items-center">
            <div class="card-title mb-0 flex-grow-1">
                ...
                <div class="float-right">
                    <a href="{{ route('sales.purchase.bill', $purchase->id) }}" class="btn btn-outline-primary">Nota Titip
                        Tagihan</a>
                </div>
            </div>
        </div>
...
@section('script')
    <script>
        ...
        $(document).on('input', '#whitePaper', function(e) {
            ...
            $.ajax({
                url: `{{ route('sales.purchase.upload-white', ':id') }}`.replace(':id', id),
                type: "POST",
                dataType: "JSON",
                data: formData,
                contentType: false,
        ...
        $(document).on('input', '#yellowPaper', function(e) {
            ...
            $.ajax({
                url: `{{ route('sales.purchase.upload-yellow', ':id') }}`.replace(':id', id),
                type: "POST",
                dataType: "JSON",
                data: formData,
                contentType: false,
        ...
        $(document).on('click', '.checkhite', function(e) {
            ...
            $.ajax({
                url: `{{ route('sales.purchase.check-white', ':id') }}`.replace(':id', id),
                type: "GET",
                dataType: "JSON",
                data: {
                    _token: '{{ csrf_token() }}'
        ...
        $(document).on('click', '.checkYellow', function(e) {
            ...
            $.ajax({
                url: `{{ route('sales.purchase.check-yellow', ':id') }}`.replace(':id', id),
                type: "GET",
                dataType: "JSON",
                data: {
                    _token: '{{ csrf_token() }}'
