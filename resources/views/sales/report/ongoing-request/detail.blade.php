...
@section('title', __('Detail Barang Keluar'))
        ...
        <div class="card-header d-flex align-items-center">
            <div class="card-title mb-0 flex-grow-1">
                <div class="btn btn-primary">
                    <h4 class="mb-0 text-light">Permintaan Barang Keluar</h4>
                </div>
            </div>
        </div>
        <div class="card-body">
                ...
                <div class="col">
                    ...
                    <div class="row list">
                        ...
                        <div class="col">
                            ...
                            <p>
                                {{ $ongoingRequest->pharmacies_count }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="item-data-total">
                        ...
                        <div>
                            ...
                            <p>{{ $ongoingRequest->pharmacies_sum }}</p>
                        </div>
                    </div>
                </div>
                {{-- <div class="col-md-6">
