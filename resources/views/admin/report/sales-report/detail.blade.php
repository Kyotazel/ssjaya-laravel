...
@section('title', __('Detail Produk Sales'))
        ...
        <div class="card-header d-flex align-items-center">
            <div class="card-title mb-0 flex-grow-1">
                <div class="btn btn-primary">
                    <h4 class="mb-0 text-light">Detail Produk Sales</h4>
                </div>
            </div>
        </div>
        <div class="card-body">
                ...
                <div class="col-md-12">
                    <div class="d-flex align-items-center">
                        ...
                        <a class="btn btn-outline-primary rounded-pill btn-label px-5 py-3"
                            href="{{ route('admin.pharmacy-report.index') . "?sales=$sales->id_sales" }}">Log</a>
                    </div>
                </div>
