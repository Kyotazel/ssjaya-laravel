                        ...
                        <div class="form-group">
                            ...
                            <select name="sales_id" id="sales_id" class="form-control">
                                ...
                                @foreach ($saless as $sales)
                                    <option {{ $purchase->sales_id == $sales->id ? 'selected' : '' }}
                        ...
                        <div class="form-group">
                            ...
                            <select name="pharmacy_id" id="pharmacy_id" class="form-control">
                                ...
                                @foreach ($pharmacies as $pharmacy)
                                    <option {{ $purchase->pharmacy_id == $pharmacy->id_apotek ? 'selected' : '' }}
                                        value="{{ $pharmacy->id_apotek }}">{{ $pharmacy->nama_apotek }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="products[{{ $indexProduct }}][product_id]"
                                            ...
                                            @foreach ($products as $product)
                                                <option
                                                    {{ $purchaseProduct->product_id == $product->id ? 'selected' : '' }}
        ...
        $(document).on('click', '.btn_submit', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `{{ route('admin.purchase.update', ':id') }}`.replace(':id', id),
                        type: "POST",
                        data: formData,
                        contentType: false,
                        processData: false,
